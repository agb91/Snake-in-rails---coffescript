...
(function() {
  var altezzaColonna, aumentaPunti, barando, checkAlive, checkFood, clean, color, death, direzione, downkey, draw, eat, food, forward, forwardDown, forwardLeft, forwardRight, forwardUp, fuori, getColor, getLabVector, getLabVector1, getLabVector2, getOpacity, getRandomInt, gnam, goon, keyb, larghezzaRiga, leftkey, leggiPunti, morto, nero, punti, readJSON, rightkey, round, serpente, setLabirinth, time, unHide, upkey, writeLabirinth;
